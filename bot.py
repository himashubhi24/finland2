    ...
    async def start(self):
        ...
        if FORCE_SUB_CHANNEL:
            ...
            try:
                ...
                self.LOGGER(__name__).warning(
                    f"Please Double check FORCE_SUB_CHANNEL value. Current Value: {FORCE_SUB_CHANNEL}"
                )
        ...
        try:
            ...
            self.LOGGER(__name__).warning(
                f"Make Sure bot is Admin in DB Channel. Current Value {CHANNEL_ID}"
            )
